...
import { ActivityIndicator, Alert, Dimensions, Image, Linking, Modal, ScrollView, Share, StatusBar, StyleSheet, Text, TouchableOpacity, useWindowDimensions, View } from 'react-native';
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        {videoId ? (
          ...
          <TouchableOpacity activeOpacity={0.9} onPress={() => setIsImageViewerVisible(true)}>
            <Image
              ...
              style={[styles.heroImage, { width: '100%' }]}
              resizeMode="cover"
            />
        ...
        >
          <View style={styles.modalOverlay}>
            ...
            <ZoomableImage uri={article.image} height={screenWidth * 1.5} />
          </View>
        </Modal>
        ...
        <View style={styles.articleBody}>
          ...
          <TouchableOpacity
            ...
            style={{ marginBottom: 20, borderRadius: 12, overflow: 'hidden', backgroundColor: '#fff', elevation: 3, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4 }}
          >
            <Image
...
const styles = StyleSheet.create({
  ...
  fullImage: {
    width: screenWidth,
    height: screenWidth * 1.5, // taller for portrait images
  },
  modalScrollContent: {
    flexGrow: 1,
    justifyContent: 'center',
